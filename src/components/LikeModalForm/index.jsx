...
const LikeModalForm = ({ text, setText, isModalOpen, setIsModalOpen, setIsLiked }) => {
        ...
        >
            ...
            <Form layout="vertical">
                ...
                <Form.Item label="Максимальное количество">
                    <Slider value={state.maxResults} max={15} onChange={handleChangeMaxResult} tooltip={{ open: true }} />
                    {/* <Input
                        type="number"
